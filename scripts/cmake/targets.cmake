...
add_custom_target(hkd_build
    COMMAND ${HK_SOURCE_UTIL_DIR}/driver_build.sh ${HK_SOURCE_ROOT_DIR} ${SOURCE_ROOT_DIR}
    USES_TERMINAL
)
...
add_custom_target(hkd_clean
    COMMAND ${HK_SOURCE_UTIL_DIR}/driver_clean.sh ${HK_SOURCE_ROOT_DIR} ${SOURCE_ROOT_DIR}
    USES_TERMINAL
)
add_custom_target_info(
    TARGET hkd_clean
...
add_custom_target(hkd_load
    COMMAND ${HK_SOURCE_UTIL_DIR}/driver_load.sh ${HK_SOURCE_ROOT_DIR}  ${SOURCE_ROOT_DIR}
    USES_TERMINAL
)
add_custom_target_info(
    TARGET hkd_load
...
add_custom_target(hkd_unload
    COMMAND ${HK_SOURCE_UTIL_DIR}/driver_unload.sh ${HK_SOURCE_ROOT_DIR} ${SOURCE_ROOT_DIR}
    USES_TERMINAL
)
add_custom_target_info(
    TARGET hkd_unload
